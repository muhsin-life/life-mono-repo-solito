...
import { CountryCode } from 'app/types/products'
...
// 'Home' | 'Category' | 'Rx Upload' | 'Profile' | 'Cart'
...
export const DEFAULT_IMAGE = "https://www.lifepharmacy.com/images/page-header-bg.jpg";
